        ...
        for (final lift in workout.lifts) {
          ...
          await txn.insert(
            TableNames.workoutTemplateLifts,
            {
              ...
              'lift_info_override': lift.liftInfoOverride,
              'score_type_override': lift.scoreTypeOverride,
              'score_multiplier_override': lift.scoreMultiplierOverride,
              'input_mode_override': lift.inputModeOverride,
